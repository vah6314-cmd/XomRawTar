      ...
      <div className="container mx-auto px-4 sm:px-6">
          ...
          {servicePackages.map((pkg) => (
            <div
              ...
              className={`relative rounded-lg shadow-lg transition-all duration-300 ${
                pkg.popular
                  ? 'ring-2 ring-blue-600 lg:transform lg:scale-105'
            ...
            >
              ...
              <div className="bg-white rounded-lg p-6 sm:p-8">
                ...
                {/* Price */}
                <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-3 sm:mb-4">{pkg.price}</div>
                  ...
                  <div className="flex items-center text-xs sm:text-sm text-gray-600">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.25a9.75 9.75 0 109.75 9.75A9.75 9.75 0 0012 2.25z"
                      />
                    </svg>
                    {pkg.support}
                  </div>
                ...
                <button
                  ...
                  className={`w-full py-3 px-4 sm:py-3 sm:px-6 rounded-full font-semibold transition-all duration-200 text-sm sm:text-base ${
                    pkg.popular
        ...
        <div className="mt-12 sm:mt-16 bg-blue-50 rounded-lg p-6 sm:p-8">
          <div className="text-center">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Need a Custom Solution?</h3>
            ...
            <button
              onClick={() => scrollToContact()}
              className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base"
            >
